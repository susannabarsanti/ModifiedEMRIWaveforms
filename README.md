...
We recommend installing few in a conda environment. In this way, after having installed few, you can clone this repository and install it in the same environment: 
